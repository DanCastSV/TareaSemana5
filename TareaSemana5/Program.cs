 ...
 * Moises Antonio Martinez Martinez SMIS071221
 * Diego Alejandro Martínez Chicas SMIS063521
 */
namespace TareaSemana5
{
    class Program
    {
        ...
        private static bool menu()
        {
            ...
            Console.WriteLine("Listado de empleados de la empresa laboratorios Star");
        ...
        {
            string paht = @"C:\Trabajo\Empleados.txt";
            return paht;
        }
        ...
        private static void update()
        {
            ...
            if (search(name))
            {
                Console.WriteLine("El regitro se ha encontrado de manera exitosa ");
                ...
                temp[name] = newPuesto;
                Console.WriteLine("El dato se ha actualizado correctamente");
                File.Delete(getPaht());
            ...
            else
            {
                ...
                Console.WriteLine("El registro no se ha encontrado, por favor intentar de nuevo");
            }
        }
    }
}
